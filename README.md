# Sustainability — `oriz-blog-sustainability`

> Living lighter, measured honestly — climate, energy, and low-waste living without the greenwash.

[![License: MIT](https://img.shields.io/badge/License-MIT-e4572e.svg)](./LICENSE)
[![GitHub stars](https://img.shields.io/github/stars/chirag127/oriz-blog-sustainability?style=flat)](https://github.com/chirag127/oriz-blog-sustainability/stargazers)
[![Last commit](https://img.shields.io/github/last-commit/chirag127/oriz-blog-sustainability)](https://github.com/chirag127/oriz-blog-sustainability/commits/main)
[![Deploy](https://github.com/chirag127/oriz-blog-sustainability/actions/workflows/deploy.yml/badge.svg)](https://github.com/chirag127/oriz-blog-sustainability/actions/workflows/deploy.yml)
[![Built with Astro](https://img.shields.io/badge/built%20with-Astro-ff5d01.svg)](https://astro.build)

**Sustainability** is a static, content-first blog built with Astro and deployed to Cloudflare Pages.
A sustainability blog covering climate, clean energy, and low-waste living — grounded in numbers and trade-offs rather than slogans.

- **Live site:** https://sustainability-blog.oriz.in · **Repo:** https://github.com/chirag127/oriz-blog-sustainability
- **GitHub Pages landing:** https://chirag127.github.io/oriz-blog-sustainability/ — the canonical, always-current site is **https://sustainability-blog.oriz.in** (Cloudflare Pages); GitHub Pages is not the deploy target for this repo.

> ⭐ **If this is useful, please [star the repo](https://github.com/chirag127/oriz-blog-sustainability/stargazers)** — it helps others find it.
...
flowchart LR
    ...
    D --> E["Cloudflare Pages<br/>sustainability-blog.oriz.in"]
...
```
oriz-blog-sustainability/
├── src/
│   ├── content/blog/       # the sustainability articles (MDX/Markdown)
