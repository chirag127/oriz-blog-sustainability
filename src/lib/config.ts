...
export const SITE_CONFIG: BlogConfig = {
  ...
  description:
    'Practical low-waste habits, honest claim-checking, and repair over replace. A sustainable-living notebook by Chirag Singhal.',
  url: 'https://sustainability-blog.oriz.in',
  defaultLocale: 'en',
  author: {
    name: 'Chirag Singhal',
  ...
  giscus: {
    repo: env('PUBLIC_GISCUS_REPO', 'chirag127/oriz-blog-sustainability') as `${string}/${string}`,
